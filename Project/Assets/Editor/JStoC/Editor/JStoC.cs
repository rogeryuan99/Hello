...
public class JStoC : EditorWindow
{
    ...
    static string ConvertToC(string output, string className)
    {
        ...
        string[] patterns = new string[36];
        string[] replacements = new string[36];
        int patrs = 0;
        int reps = 0;
		...
		//Vector2( -> new Vector2( roger
        patterns[patrs++] = @"Vector2[\s]*\(";
        replacements[reps++] = "new Vector2(";
		
		//Vector2( -> new Vector2( roger
		Debug.Log("vector2");
        patterns[patrs++] = @"new new Vector2";
        replacements[reps++] = "new Vector2";
        ...
        replacements[reps++] = "AddComponent<$2>()";
        patterns[patrs++] = @"GetComponent\(([""])([\n\r\tA-Za-z0-9_]*)([""])\)";
        replacements[reps++] = "GetComponent<$2>()";
        patterns[patrs++] = @"GetComponentsInChildren\(([""])([\n\r\tA-Za-z0-9_]*)([""])\)";
        replacements[reps++] = "GetComponentsInChildren<$2>()";
        patterns[patrs++] = @"GetComponentInChildren\(([""])([\n\r\tA-Za-z0-9_]*)([""])\)";
        replacements[reps++] = "GetComponentInChildren<$2>()";
        patterns[patrs++] = @"FindObjectsOfType\(([""])([\n\r\tA-Za-z0-9_]*)([""])\)";
        replacements[reps++] = "FindObjectsOfType(typeof($2))";
        patterns[patrs++] = @"FindObjectOfType\(([""])([\n\r\tA-Za-z0-9_]*)([""])\)";
        replacements[reps++] = @"FindObjectOfType(typeof($2))";
        //@HideInInspector roger
        patterns[patrs++] = @"@HideInInspector";
        replacements[reps++] = @"[HideInInspector]";
