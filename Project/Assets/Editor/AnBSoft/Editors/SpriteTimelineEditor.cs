...
public class SpriteTimelineEditor : EditorWindow
{
	...
	{
#if UNITY_IPHONE && !(UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3)
		if (instance != null)
		{
			instance.Show(true);
			return;
...
public class SpriteTimeline : ISTE
{
	...
	public void SetupRects()
	{
		...
		staticTexRect = new Rect(40, 50, 200, 100);
#else
		addBtnRect = new Rect(5, 5, 20, 20);
		delBtnRect = new Rect(24, 5, 20, 20);
#if	(UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3)
		...
		staticTexRect = new Rect(15, 55, 200, 100);
#endif
	}
