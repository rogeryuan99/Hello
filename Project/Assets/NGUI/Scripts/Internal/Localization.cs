	...
	static public Localization instance
	{
		get
		{
			if (mInstance == null)
			{
				...
				if (mInstance == null)
				{
					GameObject prefab = Resources.Load("gsl_dlg/Localization") as GameObject;
					GameObject go = Instantiate(prefab) as GameObject;//new GameObject("_Localization");
					DontDestroyOnLoad(go);
					mInstance = go.GetComponent<Localization>();
